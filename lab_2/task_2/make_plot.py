...
with open('threads_times.csv', 'r') as csvfile:
...
ax.plot(threads_arr[1:], small_size_times, color='green', label='N_STEPS=20000000', marker='o')
ax.plot(threads_arr[1:], big_size_times, color='red', label='N_STEPS=40000000', marker='o')
